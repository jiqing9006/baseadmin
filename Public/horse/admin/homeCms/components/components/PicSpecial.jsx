...
class PicSpecialModal extends React.Component {
    ...
    render() {
        ...
        let {list = [], name, sec_name, icon} = this.state;
                ...
                list.map((d, i) => <div key={i}>
                    ...
                    >
                        <Row>
                            ...
                            <Col span={20}>
                                <Form >
                                    <FormItem extra="图片尺寸 710*370" label="图片" hasFeedback {...formItemLayout}>
                                        {
...
class PicSpecial extends React.Component {
    ...
    render() {
        ...
        return <div>
            <CmsBaseComponent {...this.props} name={data.name ? `图片专题(${data.name})` : "图片专题"} onEdit={() => {
                self.setState({
                    visible: true
                });
            }}/>
