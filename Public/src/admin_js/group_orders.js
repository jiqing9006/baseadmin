$(function () {
    ...
    $(".order_detail").on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: "/admin.php/Grouporders/get_detail",
            data: {order_id: id},
            dataType: "json",
            success: function(data){
                $("#scroll_goods").html('');
    ...
    $(".refund_apply_detail").on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: "/admin.php/Grouporders/get_refund_express_info",
            data: {order_id: id},
            dataType: "json",
            success: function(data){
                var info = data.info;
    ...
    $(".refund_money_reason").on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: "/admin.php/Grouporders/get_refund_reason",
            data: {order_id: id},
            dataType: "json",
            success: function(data){
                var info = data.info;
    ...
    $(".blank_express").on('click', function () {
        ...
        if(flag == 1){
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/get_express_info",
                data: {order_id: id},
                dataType: "json",
                success: function(data){
                    var info = data.info;
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/get_express_node",
                data: {order_id: id},
                dataType: "json",
                success: function(data){
                    var info = data.info;
    ...
    $("#add-express-btn").on('click', function () {
        ...
        if(is_refund == 1){
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/add_refund_express",
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/add_express",
                data: {order_id: order_id, express_id: express_id, express_code: express_code},
                dataType: "json",
                success: function(data){
                    if(data.errno == 1){
    ...
    $(".refund_return").on('click', function () {
        if(confirm('确定驳回退款吗？点击确定后将不会被恢复!')){
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/refund_return",
    ...
    $(".finish_refund").on('click', function () {
        if(confirm('确定完成退款了吗？点击确定后将不会被恢复!')){
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/finish_refund",
                data: {order_id: order_id},
                dataType: "json",
                success: function(data){
                    alert(data.errdesc);
    ...
    $(".make_rejected").on('click', function () {
        if(confirm('确定同意退货吗？点击确定后将不会被恢复!')){
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/make_rejected",
                data: {order_id: order_id},
                dataType: "json",
                success: function(data){
                    alert(data.errdesc);
    ...
    $(".refuse_rejected").on('click', function () {
        if(confirm('确定驳回退货吗？点击确定后将不会被恢复!')){
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/refuse_rejected",
                data: {order_id: order_id},
                dataType: "json",
                success: function(data){
                    alert(data.errdesc);
    ...
    $(".complete_rejected").on('click', function () {
        if(confirm('确定收到退货并且已退款了吗？点击确定后将不会被恢复!')){
            ...
            $.ajax({
                type: "post",
                url: "/admin.php/Grouporders/complete_rejected",
                data: {order_id: order_id},
                dataType: "json",
                success: function(data){
                    alert(data.errdesc);
